          ...
          <View className="bg-[#033A0280] bg-opacity-50 p-4 h-3/4 w-3/4 items-center ">
            ...
            <View className="pt-16 w-80 h-auto items-center">
              <View className="mb-4 pl-13">
                ...
                <Text className="pt-8 text-white text-sm font-medium">Buat Kata Sandi</Text>
                <TextInput
                  secureTextEntry={true}
                  className="w-64 h-9 pl-1 text-white text-left border-b-2 border-white" />
                <Text className="pt-8 text-white text-sm font-medium">Ulang Kata Sandi</Text>
                <TextInput
                  secureTextEntry={true}
                  className="w-64 h-9 pl-1 text-white text-left border-b-2 border-white" />
            ...
            <View>
            <Text className="text-white pt-5 text-xs font-normal leading-4 font-roboto font-weight-400 text-center tracking-wide">
