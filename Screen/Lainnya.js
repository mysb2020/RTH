...
const Lainnya = () => {
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <Image
            source={require('../assets/pen.png')} // Ganti dengan path yang sesuai ke gambar kamera Anda
      ...
      <View className="top-[-600] items-center p-5 h-screen">
        ...
        <Image
            source={require('../assets/wallet.png')} // Ganti dengan path yang sesuai ke gambar kamera Anda
            style={{ width: 23, height: 23 }}
            />
