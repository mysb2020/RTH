  ...
  return (
    <SafeAreaView className="flex-1 bg-lime-50">
            ...
            <ScrollView>
                ...
                <Image source={require('../../assets/autumn.jpg')} className=" h-[289]" />
                <View className="flex-1 h-[320px] p-5 top-[-80px] left-[110]" >
                    <Image source={require('../../assets/autumn.jpg')} className=" absolute top-[25] left-[20] h-[113px] w-[140px] rounded-md" style={{
                        borderWidth: 2,
                        borderColor: 'white',
                    }} />
